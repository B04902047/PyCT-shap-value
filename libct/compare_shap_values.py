...
class ShapValuesComparator:
    ...
    def compare(self, positioned_contraint_1: PositionedConstraint, positioned_contraint_2: PositionedConstraint) -> float:
        constraint_1, (row_number_1, indices_1) = positioned_contraint_1
        constraint_2, (row_number_2, indices_2) = positioned_contraint_2
