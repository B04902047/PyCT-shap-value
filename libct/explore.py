...
class ExplorationEngine:
    ...
    def explore(
            self, model_path, modpath, input_for_shap, background_dataset_for_shap, all_args={}, /, *, root='.', funcname=None,
            ...
            collect_contraints_with: Literal['stack', 'queue', 'priority_queue'] = 'priority_queue'):
        ...
        self.constraints_collection_type: Literal['stack',
                                                  'queue', 'priority_queue'] = collect_contraints_with
