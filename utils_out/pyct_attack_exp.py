...
def get_save_dir_from_save_exp(save_exp, model_name, s_or_q_or_p, only_first_forward=False):
    if only_first_forward:
        save_dir = os.path.join("exp", model_name + "_only_first_forward", s_or_q_or_p, save_exp['exp_name'], save_exp['input_name'])
    else:        
        save_dir = os.path.join("exp", model_name, s_or_q_or_p, save_exp['exp_name'], save_exp['input_name'])
    return save_dir
